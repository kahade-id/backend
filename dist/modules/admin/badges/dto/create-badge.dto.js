...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Badge name', maxLength: 60 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Badge icon URL', maxLength: 500 }),
    (0, class_transformer_1.Transform)(trimString),
    (0, class_validator_1.IsUrl)({}, { message: 'iconUrl must be a valid URL' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.MaxLength)(500),
    __metadata("design:type", String)
], CreateBadgeDto.prototype, "iconUrl", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Badge description', maxLength: 1000 }),
    (0, class_transformer_1.Transform)(trimString),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Badge name', maxLength: 60 }),
    (0, class_transformer_1.Transform)(trimString),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Badge icon URL', maxLength: 500 }),
    (0, class_transformer_1.Transform)(trimString),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUrl)({}, { message: 'iconUrl must be a valid URL' }),
    (0, class_validator_1.IsNotEmpty)(),
