...
exports.CorrectEmailDto = void 0;
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
const class_transformer_1 = require("class-transformer");
class CorrectEmailDto {
}
exports.CorrectEmailDto = CorrectEmailDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'New email address', maxLength: 254 }),
...
], CorrectEmailDto.prototype, "newEmail", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Current password for verification', maxLength: 72 }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Password is required' }),
    (0, class_validator_1.MaxLength)(72),
    __metadata("design:type", String)
], CorrectEmailDto.prototype, "password", void 0);
__decorate([
    ...
    __metadata("design:type", String)
], CorrectEmailDto.prototype, "mfaCode", void 0);
