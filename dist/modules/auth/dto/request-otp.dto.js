...
exports.RequestOtpDto = exports.OtpMethodDto = void 0;
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
const class_transformer_1 = require("class-transformer");
const device_id_validation_1 = require("./device-id.validation");
var OtpMethodDto;
(function (OtpMethodDto) {
    OtpMethodDto["SMS"] = "SMS";
    OtpMethodDto["WHATSAPP"] = "WHATSAPP";
})(OtpMethodDto || (exports.OtpMethodDto = OtpMethodDto = {}));
class RequestOtpDto {
}
exports.RequestOtpDto = RequestOtpDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Indonesian phone number (e.g. 08xx or +628xx)', maxLength: 20 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'OTP delivery method', enum: OtpMethodDto }),
    (0, class_validator_1.IsEnum)(OtpMethodDto, { message: 'Method must be SMS or WHATSAPP' }),
    __metadata("design:type", String)
], RequestOtpDto.prototype, "method", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Stable device identifier that requested the OTP', maxLength: 255 }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
