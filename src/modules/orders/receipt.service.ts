...
export class ReceiptService {
  ...
  async generateReceiptHtml(orderId: string, userId: string): Promise<string> {
...
<div class="row"><span class="label">Order Value</span><span class="value">${formatCurrency(toIdr(order.orderValue))}</span></div>
<div class="row"><span class="label">Platform Fee (${Number(order.feeRate).toFixed(1)}%)</span><span class="value">${formatCurrency(toIdr(order.feeAmount))}</span></div>
<div class="row"><span class="label">Buyer Fee</span><span class="value">${formatCurrency(toIdr(order.buyerFeeAmount))}</span></div>
<div class="row"><span class="label">Seller Fee</span><span class="value">${formatCurrency(toIdr(order.sellerFeeAmount))}</span></div>
${order.voucherDiscount > BigInt(0) ? `<div class="row"><span class="label">Voucher Discount (${escapeHtml(order.voucher?.code)})</span><span class="value" style="color:#10b981">-${formatCurrency(toIdr(order.voucherDiscount))}</span></div>` : ''}
<div class="row total-row"><span class="label"><strong>Total Buyer Pays</strong></span><span class="value">${formatCurrency(toIdr(order.buyerPayAmount))}</span></div>
<div class="row total-row"><span class="label"><strong>Total Seller Receives</strong></span><span class="value">${formatCurrency(toIdr(order.sellerReceiveAmount))}</span></div>
</div>
